...
### Fixed
- Lazy initialize heuristics to prevent crashes of the application

## [1.1.5] - 2026-01-11
### Fixed
- Wrong processing of certain URL campaigns

## [1.1.4] - 2025-12-10
### Added
- Add proper consumer proguard rules

## [1.1.3] - 2025-11-27
### Changed
- Report properly campaign to BE
